...
@section('titulo','Actualizar datos de articulo')
@section('detalle','en esta seccion se visualiza el formulario de actualización del articulo')
            ...
            <div class="col-xs-12 col-sm-12">
                <div class="widget-box">
                    <div class="widget-header">
                        <h4 class="widget-title">Datos a Actualizar (Articulos)</h4>
